...
import {
  createOpportunity, updateOpportunity, setOpportunityStatus, deleteOpportunity,
} from '@/lib/data'
import {
...
export function OpportunityForm({ opportunity: o, stages, clients, owners, companyId, onClose, onSaved }: Props) {
