// components/profitability/ProfitabilityClient.tsx
'use client'
...
export function ProfitabilityClient({ consultants = [], error }: Props) {
  ...
  return (
    <div className="app-content">
      ...
      {alertCible > 0 && (
        <div className="alert-warning">{t('alertCible', { count: alertCible })}</div>
      )}
      ...
      <Panel title={t('table.countLabel', { count: sorted.length })} noPadding>
        {error ? (
                          ...
                          {c.tjm_cout != null ? (
                            <div className="tjm-cell">
                              ...
                              <span className="tjm-cell-label">
                                {c.contract_type === 'employee' ? t('table.charged') : t('table.billed')}
                              </span>
                            </div>
