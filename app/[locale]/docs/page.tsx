    ...
    <>
      <style>{`
        ...
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .pillar-label{color:'#fff';font-weight:700;margin-bottom:4px;color:white;}
      ...
      <div className="wrap">
        ...
        <section className="hero">
          <div className="hero-eyebrow">
            <span>Beta 2026</span> professional services automation
          </div>
          <h1 className="hero-title">
            the operating system<br />
            for <em>consulting</em><br />
            <strong>firms<span className="cursor">_</span></strong>
          </h1>
          <p className="hero-desc">
            <Staff7 /> centralises staffing, project tracking, timesheets, and leave management
            for <b>ESNs, agencies, and consulting firms</b> — with an AI layer that understands
            your data and works the way you do.
          </p>
          ...
          <div className="pillars">
            {[
              ...
              { icon:'◧', label:'Project tracking', desc:'External and internal projects, clients, financial margins per mission.' },
              { icon:'⚡', label:'AI console', desc:'Ask your data in plain language. Local or cloud LLM, your choice.' },
              { icon:'🔐', label:'Privacy-by-design', desc:'Multi-tenant, RLS-enforced. Data never leaves without your consent.' },
            ].map((p,i) => (
          ...
          <div className="portal">
            <Link href="/docs/platform" className="portal-card platform">
              ...
              <p className="portal-desc">
                Everything the platform does out of the box — workflows, roles, timesheets,
                leave management, project staffing, and financial tracking.
              </p>
            ...
            <Link href="/docs/ai" className="portal-card ai">
              ...
              <p className="portal-desc">
                The intelligence layer built on top of the platform — bring your own model,
                natural language queries, MCP integration, and autonomous agents.
              </p>
              <div className="portal-topics">
          ...
          <div className="diff-grid">
            {[
              { num:'01', title:'Sub-15€ / user / month', desc:'Designed for boutique agencies and independents. No enterprise pricing, no seat minimums.' },
              { num:'02', title:'Privacy-by-design AI', desc:'Run a local Ollama model — your staffing data never leaves your infrastructure.' },
              { num:'03', title:'Real-time profitability', desc:'TJM, margins, sold vs actual days — financial data at project level, gated by role.' },
              { num:'04', title:'Built for ESNs', desc:'Multi-tenant from day one. Intercontrat, formation, avant-vente — modelled natively.' },
            ].map(d => (
        ...
        <div className="doc-footer">
          <span style={{ fontSize:10, color:'var(--text2)', letterSpacing:2 }}>
            <Staff7 /> · cloudflare · supabase · ollama · beta 2026
          </span>
