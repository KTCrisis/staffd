        ...
        <section className="hero">
          ...
          <div className="pillars">
            {[
              ...
              { icon:'⚡', label:'Agentic AI',         desc:'Ask your data — and act on it. Approve leaves, update projects, assign consultants via natural language.' },
          ...
          <div className="portal">
            ...
            <Link href="/docs/ai" className="portal-card ai">
              ...
              <p className="portal-desc">
                Natural language queries and agentic actions — approve leaves, update
                projects, assign consultants. Tool calling native, local or cloud, privacy-first.
              </p>
              <div className="portal-topics">
                {['Local LLM','Cloud API','Tool calling','Agentic actions','MCP Protocol','Privacy-by-design'].map(t => (
                  <span key={t} className="portal-tag">{t}</span>
                ))}
              </div>
